 ...
 */
if (
  ((ColorThief.prototype.getColor = function(a, b) {
        ...
        if (o[i] > n / 2) {
          for (
            e = c.copy(),
              ...
              g =
                d >= b
                  ? Math.min(c[j] - 1, ~~(i + d / 2))
                  : Math.max(c[h], ~~(i - 1 - b / 2));
            !o[g];
    ...
    (c.prototype = {
      volume: function(a) {
        ...
        return (
          (!b._volume || a) &&
            (b._volume =
              (b.r2 - b.r1 + 1) * (b.g2 - b.g1 + 1) * (b.b2 - b.b1 + 1)),
          b._volume
        );
      },
      count: function(b) {
    ...
    (d.prototype = {
      ...
      nearest: function(a) {
        for (var b, c, d, e = this.vboxes, f = 0; f < e.size(); f++)
          (c = Math.sqrt(
            Math.pow(a[0] - e.peek(f).color[0], 2) +
              Math.pow(a[1] - e.peek(f).color[1], 2) +
              Math.pow(a[2] - e.peek(f).color[2], 2)
          )),
